  ...
  object Memo1: TMemo
    ...
    Lines.Strings = (
      ...
      ''
        ...
        'def absorptionCoefficient_LorentzCalc(pClientId, pTableName, pM_' +
        'Id, pI_Id, pDiluent, pDiluentValue, pMinWn, pMaxWn):'
      #9'print(pClientId)'
      #9'print(pTableName)'
      #9'print(pDiluent)'
      ...
      #9'fetch(pTableName,pM_Id,pI_Id,pMinWn,pMaxWn)'
      
        #9'a_DiluentJson = json.loads('#39'{"'#39' +pDiluent + '#39'":'#39' + str(pDiluent' +
        'Value) + '#39'}'#39')'#9
      
        #9'nu,coef = absorptionCoefficient_Lorentz(SourceTables= pTableNam' +
        'e, Diluent= a_DiluentJson)'
      #9'numax = np.max(coef)'
      #9'coef =  coef/numax'
      ...
      #9#9'os.makedirs(a_ChartPath)'
        ...
        #9'a_ChartFn = pClientId + "_" + pTableName+ "_" +  str(pM_Id) + "' +
        '_" + str(pI_Id) + "_" +  pDiluent + "_" + str(pDiluentValue).rep' +
        'lace('#39'.'#39', '#39'_'#39') + "_" + str(pMinWn)+ "_" +str(pMaxWn) + "_Chart.t' +
        'xt"'
      #9'print(a_ChartFn)'
